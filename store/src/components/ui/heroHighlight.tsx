...
export const HeroHighlight = ({ children, className, containerClassName }: {
  ...
  return (
    <div
      className={cn(
        "relative min-h-[80vh] flex items-center bg-white justify-center w-full group",
        containerClassName
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block pb-1   px-1 rounded-lg bg-gradient-to-r from-violet-600 to-indigo-600`,
        className
      )}
    >
      {children}
